...
export const PLANS: readonly PlanConfig[] = [
  {
    ...
    tier: "starter",
    name: "Starter",
    description: "For solo developers running their first agent.",
    features: [
      "1 active OpenClaw instance",
      "Standard CX servers",
      "Community support",
      "Basic monitoring",
      "Daily backups",
  ...
  },
  {
    ...
    tier: "pro",
    name: "Pro",
    description: "For teams shipping production AI agents.",
    features: [
      "Up to 10 OpenClaw instances",
      "All server tiers (CX, CPX, CAX, CCX)",
      "Priority email support",
      "Advanced monitoring & alerts",
      "Hourly backups",
      "Custom SSH keys",
      "Managed configuration tuning",
    ],
  ...
  },
  {
    ...
    tier: "enterprise",
    name: "Enterprise",
    description: "For organizations running mission-critical AI ops.",
    features: [
      "Unlimited instances",
      "Dedicated CCX servers",
      "Dedicated success engineer",
      "24/7 phone + Slack support",
      "Custom SLAs",
      "On-call agent health monitoring",
