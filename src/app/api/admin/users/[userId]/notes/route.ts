...
import { db, eq, desc, adminNotes, users } from "@/db"
import { z } from "zod"
...
export async function GET(
  ...
  try {
    ...
    const notes = await db.query.adminNotes.findMany({
...
export async function DELETE(
  ...
  try {
    ...
    await db.delete(adminNotes).where(eq(adminNotes.id, validation.data.noteId))
