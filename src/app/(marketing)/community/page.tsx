  ...
  return (
    <div className="bg-[#0a0a0f] min-h-screen">
      <div className="max-w-4xl mx-auto px-6 py-20">
        <h1 className="text-4xl md:text-5xl font-bold text-white text-center">Join Our Community</h1>
        <p className="mt-4 text-zinc-400 text-lg text-center max-w-xl mx-auto">
          Connect with fellow Agentic AI users, get real-time updates, and stay ahead in the race.
        </p>

        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center hover:border-blue-500/30 transition-colors">
            ...
            <p className="mt-3 text-zinc-400 text-sm leading-relaxed">
              Get instant product updates, new model launches, and connect directly with our team and
              community members.
            </p>
            <a
              href="#"
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 text-center hover:border-zinc-500/30 transition-colors">
